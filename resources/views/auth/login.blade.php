...
<section class="text-center text-lg-start">
  ...
  <div class="container py-4">
    <div class="row g-0 align-items-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="password" class="block mt-1 w-fullc form-control" type="password" name="password" required autocomplete="current-password" />
            </div>
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <img src="https://i.pinimg.com/originals/61/8b/ba/618bba4b831a9d06023900a5484d4df0.png" class="w-100 rounded-4 shadow-4"
          alt="" />
      </div>
    </div>
  </div>
